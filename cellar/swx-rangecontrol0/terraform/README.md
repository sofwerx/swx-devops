# swx-rangecontrol0 terraform

This is for AWS Route53 DNS resources for swx-u-ub-rangecontrol0
...
or run this:
    ...
    terraform init --backend-config="key=swx/rangecontrol0/terraform.tfstate"
